...
tasks.jar {
    ...
    destinationDirectory.set(file("../../YukariLauncher/src/main/assets/components/lwjgl3/3.3.3/"))
    // Auto update the version with a timestamp so the project jar gets updated by Pojav
    doLast {
        val versionFile = file("../../YukariLauncher/src/main/assets/components/lwjgl3/3.3.3/version")
